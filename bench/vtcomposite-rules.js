...
module.exports = [
  ...
  , 
  { 
    // set to 4080 so we can have an apples to apples comparsion to node-mapnik
    // https://github.com/mapbox/mapbox-maps/blob/master/lib/tilelive-multivector.js#L232
    description: 'buffer_size 4080 - tiles completely made of polygons, overzooming (2x) and lots of properties',
    options: {buffer_size: 4080},
    tiles: [
      { z: 15, x: 5239, y: 12666, buffer:  fs.readFileSync('./test/fixtures/polygons-buildings-sf-15-5239-12666.mvt')},
      { z: 15, x: 5239, y: 12666, buffer: fs.readFileSync('./test/fixtures/polygons-hillshade-sf-15-5239-12666.mvt')}
    ], 
