 ...
 * @param {Boolean} [options.compress=true] a boolean value indicating whether or not to return a compressed buffer. Default is to return a uncompressed buffer.
 * @param {Number} [options.buffer_size=128] the buffer size of a tile, indicating the tile extent that should be composited and/or clipped. Default is `buffer_size=0`.
 *
 * @example
