        ...
        try
        {
            ...
            while (auto layer = tile.next_layer())
            {
                ...
                while (auto feature = layer.next_feature())
                {
                    ...
                    std::vector<std::pair<std::string, vtzero::property_value>> language_properties_to_be_added_to_final_properties;
                            ...
                            utils::startswith(property_key, baton_data_->hidden_prefix + baton_data_->language_property))
                        {
                            ...
                            if (is_international_tile_with_all_languages) {
                                ...
                                if(property_key == baton_data_->language_property) {
                                    ...
                                    // add other languages to a temporary list 
                                    language_properties_to_be_added_to_final_properties.emplace_back(
                                        cleaned_property_key,
                                        property.value()
                                    );
                                }
